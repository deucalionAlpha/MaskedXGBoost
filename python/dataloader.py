...
class DataLoader():
    ...
    def _load_nomao(self, data_dict, seed, test_size, remove_missing, verbose):
        nomao_data = pd.read_csv("../data/UCI Nomao/Nomao.data", delimiter=",", lineterminator="\n", header=None)
        no_missing_cols = []
        ...
        data_dict["nomao"+"_"+str(seed)] = nomao_X, nomao_X, nomao_y, nomao_y

    def _load_adult(self, data_dict, seed, test_size, remove_missing, verbose):
        adult = pd.read_csv("../data/UCI Adult/adult.data", header=None, na_values=" ?")
        print(adult.columns)
        ...
        data_dict["adult"+"_"+str(seed)] = adult_X, adult_X, adult_y, adult_y
    ...
    def _load_bank_marketing(self, data_dict, seed, test_size, remove_missing, verbose):
        bank_df = pd.read_csv("../data/UCI Bank Marketing/bank-full.csv", sep=";")
        ...
        data_dict["Bank"+"_"+str(seed)] = bank_X, bank_X, bank_y, bank_y
