//
// ThunderGBM syncmem: https://github.com/Xtra-Computing/thundergbm/blob/master/include/thundergbm/syncmem.h
...
namespace thunder {
    ...
    public:
        ...
        static void clear_cache() { device_allocator.FreeAllCached(); host_allocator.FreeAllCached();};
